...
export const ecommerceDetailPageSkill: AppAgentSkill = {
  ...
  buildPromptPatch: () => [
    ...
    'Default renderMode is model_text_baked: image model generates a complete ecommerce detail-page layout with readable Simplified Chinese page number, title, subtitle, selling-point chips/icons, detail cards and product imagery.',
