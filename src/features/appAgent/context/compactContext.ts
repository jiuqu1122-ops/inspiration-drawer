      ...
      drawer: {
        ...
        items: compactDrawerItems.map(item => ({
          ...
          inspirationProfile: item.inspirationProfile ? {
            itemId: item.inspirationProfile.itemId,
            summary: compactText(item.inspirationProfile.summary),
            objects: item.inspirationProfile.objects.slice(0, 6),
            category: item.inspirationProfile.category,
            form: item.inspirationProfile.form,
            cmf: item.inspirationProfile.cmf,
            style: item.inspirationProfile.style.slice(0, 8),
            interaction: item.inspirationProfile.interaction.slice(0, 6),
            scene: item.inspirationProfile.scene.slice(0, 6),
            mood: item.inspirationProfile.mood.slice(0, 6),
            userTags: item.inspirationProfile.userTags.slice(0, 12),
            userNotes: item.inspirationProfile.userNotes.slice(0, 6).map(note => compactText(note, 120)),
          } : undefined,
        })),
      },
    } : {}),
